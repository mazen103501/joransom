...
if($do=='dashborad'){
    ...
    <div class="who-are-we" id="whoarewear">
        <h2>من نحن</h2>
        <p>
            - شركة الفدية للأمن السيبراني (Ransom Company For Cyber Security) هي شركة محلية متخصصة في الأمن السيبراني مقرها شمال الاردن في محافظة اربد - المملكة الاردنية الهاشمية
        </p>
        <p>
        ...
        <p>- نحن نساعد المؤسسات على التخطيط وبناء وتشغيل برامج أمن المعلومات الناجحة ، وحل مشاكل الأمان ، وتنفيذ مشاريع محددة لأمن تكنولوجيا المعلومات</p>
        <p>
